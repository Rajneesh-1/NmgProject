...
import 'package:nmg/home/widget/my_app_bar.dart';
...
class _MyScaffoldState extends State<MyScaffold> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: widget.showAppBar ? MyAppBar(appBackGroundColor: widget.appBackGroundColor, title: widget.appBarTitle, showLoginBtnOnAppBar: widget.showLoginBtnOnAppBar, onBackButton: widget.onBackButton) : null,
      body: widget.body,
